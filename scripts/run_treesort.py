   ...
   def process_phyloxml_clade(self, m: re.Match):
      ...
      if property_match:
         ...
         if property and len(property) > 0:
            ...
            if reassorted_match and reassorted_match.group("reassorted") == "1":
               ...
               for sd in PHYLOXML_REGEX.SEGMENT_AND_DIST.finditer(property):
                  ...
                  properties += (
                     ...
                     #f'<property ref="{PHYLOXML_PROPERTY_REF.ntDistance}" datatype="xsd:string" applies_to="node">{distance}</property>'
            ...
            #else:
               #properties += (
               #   f'<property ref="{PHYLOXML_PROPERTY_REF.isReassorted}" datatype="xsd:string" applies_to="node">no</property>'
               #)
